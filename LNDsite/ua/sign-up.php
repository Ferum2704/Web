...
<body>
    ...
    <div id="formLoginDiv" style="padding-top: 200px; padding-bottom: 500px;">
      <form action="" id="formLogin" method="post">
        <h3 style="color: white;">Create your new account</h3> <br>
        ...
        <input type="password" placeholder="Repeat password" name = "repeatedpassword" id = "repeatedpassword"><br> <br>
        <button type="submit" name = "done" style="color: white; background: red;">Sign up</button>
      </form>
    </div>
